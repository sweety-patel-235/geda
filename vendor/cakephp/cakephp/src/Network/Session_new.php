...
use Cake\Network\Session\MyDatabase;
...
class Session
{
    ...
    public function read($name = null)
    {
        ...
        if (is_string($result['data'])) {
            ...
            return (Hash::get($session, $name));
            /*$arrSession     = explode(".",$name);
            if(count($arrSession)>=2) {
                return $session[$arrSession[0]][$arrSession[1]];
            } else {
                return $session[$arrSession[0]];
            }*/
        }
