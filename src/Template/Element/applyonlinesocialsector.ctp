            ...
            <div id="content" class="mainbox">
                <table width="100%">
                    <tr>
                        ...
                        <?php echo $logo_image;?>
                        <div align="center">
                            <p class="td_bold" style="color:black;margin-bottom:0;font-size: 22px;">GUJARAT ENERGY DEVELOPMENT AGENCY</p>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td align="right" class="td_simple">
                                        <p>
                                            <span style="margin-right:15px"> Date: <?php 
                    ...
                    <tr>
                        <td class="td_simple">
                            <div style="margin-top:5px">
                                Your application is registered for installation of the rooftop solar system of <?php echo $ApplyOnlines->pv_capacity; ?> kW DC solar PV module (the “Capacity”) under <u>Institutional-social</u> sector.    
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="td_simple">
                            <div style="margin-left:15px">
                                ...
                                <p>8. The subsidy eligibility shall be on the basis of the INDIAN MAKE SPV module capacity in kW or on the basis of the invertor capacity in kVA, whichever is lower. Non-Indian make SPV Panel shall not be eligible for the Subsidy.</p>
                                <p>9. You shall certify and sign the completion report in prescribed format upon the installation of the bi-directional meter and commissioning of the system.</p>
                                <p>10. You shall certify in prescribed format that the rooftop solar PV system has been supplied to you by the selected GEDA Empaneled Vendor at a cost after deduction of the eligible subsidy and authorize GEDA to release the eligible subsidy to the GEDA Empaneled Vendor selected by you, upon submission of the claim supported with all relevant documents to GEDA.</p>
                                <p>11. The subsidy for eligible institutions shall be at 30 % of the price per kW discovered by GEDA through tender.</p>
                                <p>12. The above discovered cost is inclusive of the structure for mounting of the solar panels, with minimum surface clearance of 300 mm between the terrace surface and the bottommost edge of the panel. The cost of additional height of the structure required, if any, shall be borne by you.</p>
                                <p>13. The system cost discovered by GEDA is inclusive of supply, installation and commissioning of the complete solar system, bi-directional meter and its testing charges, SMC box for the meter and the connectivity charges of DISCOM and comprehensive maintenance contract of 5 years with free replacement of guaranteed parts against manufacturing defects. However, the Registration Fees/Charges of GEDA, cost of the stamp paper for connectivity agreement and system strengthening required, if any, as may be decided by the DISCOM upon the technical feasibility of grid connectivity, shall be borne by you.</p> 
                                <p>14. The Application for RTPV scheme shall be cancelled in case the i) the Applicant does not respond to the queries raised by Discom/GEDA in 15 days; ii) the Applicant does not make the payment of estimate amount within 30 days of the issue of the estimate.</p>
                                <?php if(isset($NewText) && !empty($NewText)){?>
                                    <p>15. <?php echo $NewText ?></p>
                                <?php } ?>
                            </div>          
                        </td>
                    </tr>
