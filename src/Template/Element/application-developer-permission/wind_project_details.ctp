                                        ...
                                        <td style="text-align: left;">
                                            ...
                                            <div class="row land-details">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <?php echo $this->Form->select('land_category[]', $landCategory, array('label' => false, 'value' => $land, 'class' => 'rfibox land_category_cls', 'id' => "land_category_" . $key, 'empty' => 'Select Category')); ?>

                                                </div>
                                                <div class="col-md-2">
                                                    <label>Plot/Servey No.<span class="mendatory_field">*</span></label>
                                                    <?php echo $this->Form->input('land_plot_servey_no[]', array('label' => false, 'value' => $value['land_survey_no'], 'class' => 'rfibox land_plot_servey_no_cls', 'placeholder' => 'Land Plot Servey No', 'id' => 'land_plot_servey_no_' . $key )); ?>
                                                </div>
                                                <div class="col-md-3">
                                                    <label>District<span class="mendatory_field">*</span></label>
                                                    <?php echo $this->Form->select('land_district[]', $arrDistictData, array('label' => false, 'value' => $value['geo_district'], 'class' => 'rfibox land_district_cls', 'id' => 'land_district_' . $key, 'empty' => 'Select District')); ?>
                                                </div>
                                                <div class="col-md-2">
                                                    <label>Taluka/Village<span class="mendatory_field">*</span></label>
                                                    
                                                    <?php echo $this->Form->select('land_taluka[]', $arrTalukaData, array('label' => false, 'value' => $value['geo_district'], 'class' => 'rfibox land_district_cls', 'id' => 'land_taluka_' . $key, 'empty' => 'Select Taluka')); ?>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <?php echo $this->Form->select('land_state[]', $arrStateData, array('label' => false, 'value' => 'Gujarat', 'class' => 'rfibox land_state_cls', 'id' => 'land_state_' . $key, 'empty' => 'Select State')); ?>
                                            ...
                                            <div class="row land-details">
                                                <div class="col-md-2">
                                                    ...
                                                    <?php echo $this->Form->input('land_latitude[]', array('label' => false, 'value' => $value['x_cordinate'], 'class' => 'rfibox land_latitude_cls', 'placeholder' => 'Latitude', 'id' => 'land_latitude_' . $key, 'oninput'=>'validateEastingDecimalInput(this)')); ?>
                                                </div>
                                                <div class="col-md-2">
                                                    <label>UTM Northing<span class="mendatory_field">*</span> </label>
                                                    <?php echo $this->Form->input('land_longitude[]', array('label' => false, 'value' => $value['y_cordinate'], 'class' => 'rfibox land_longitude_cls', 'placeholder' => 'Longitude', 'id' => 'land_longitude_' . $key, 'oninput'=>'validateNorthingDecimalInput(this)')); ?>
                                                </div>
