            ...
            <div id="content" class="mainbox">
                <table width="100%">
                    ...
                    <tr>
                        <td class="td_simple">
                            <div style="margin-top:5px">
                                Your application is registered for installation of the rooftop solar system of <?php echo $ApplyOnlines->pv_capacity; ?> kW DC solar PV module (the “Capacity”) under <u><?php echo $category_name;?></u>
                                sector.      
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="td_simple">
                            <div style="margin-top:5px">
                                This Registration Letter is copied to the selected Registered Solar PV Installer, the Chief Electrical Inspector and to the DISCOM in whose service area the rooftop system is to be located, for their further process. The registration of your project shall be governed by the following terms and conditions:
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="td_simple"> 
                            <div style="margin-left:15px"> 
                                ...
                                <p>8. You shall certify and sign the completion report in prescribed format upon the installation of the bi-directional meter and commissioning of the system.</p> 
                                <p>9. You shall certify in prescribed format that the rooftop solar PV system has been supplied to you by the selected GEDA Empaneled Vendor or any Solar PV Installer having registered at the Unified Portal for Rooftop Solar PV system selected by you.</p>
                                <p>10. The Application for RTPV scheme shall be cancelled in case the i) the Applicant does not respond to the queries raised by Discom/GEDA in 15 days; ii) the Applicant does not make the payment of estimate to the DISCOM amount within 30 days of the issue of estimate.</p>
                                <?php if(isset($NewText) && !empty($NewText)){?>
                                    <p>11. <?php echo $NewText ?></p>
                                <?php } ?>
                                <p>
                            </div>          
                        </td>
