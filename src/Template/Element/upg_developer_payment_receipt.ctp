							...
							<table style="border:1px solid #000000;border-collapse: collapse;" cellpadding="2" width="100%">
								<tr>
									<td rowspan="3" style="width:52%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;" >
										...
										<?php echo $InstallersData->installer_name;?><br>
										<?php echo $InstallersData->address;?>
										<br>
										<?php echo $InstallersData->city;?> - <?php echo $InstallersData->pincode;?>
									</td>
					...
					<tr>
						<td class="td_simple" >
							<table style="border:1px solid #000000;border-collapse: collapse;" cellpadding="5" width="100%">
								...
								<?php $developerFeesTotal=0; $count=1; ?>
								<?php foreach($arrMapCategory as $titleCategory=>$developerFee) { ?>
									<tr>
										<td style="width:10%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: center;" class="td_simple"><?php echo $count ?>.
										</td>
										<td style="vertical-align: top;width:65%;border-right: 1px solid #000000;border-bottom: 1px solid #000000;" class="td_simple">
											Processing Fee - <?php echo ($titleCategory == 1) ? 'Resco' : $titleCategory ;?>
										</td>
										<td style="width:25%; vertical-align: top;border-bottom: 1px solid #000000;text-align: center;" class="td_simple">
											<?php echo $developerFee;?>
										</td>
										<?php $developerFeesTotal+=$developerFee; $count++; ?>
									</tr>
								<?php } ?>
								
								<?php
								$cgst           = isset($gst)?$gst/2:0;
								$total_amount   = $developerFeesTotal + $cgst + $cgst;
								?>
								<tr>
									<td  style="width:10%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: center;" class="td_simple"><?php echo $count++; ?>.
									</td>
								...
								<tr>
									<td colspan="2" style="border-bottom: 1px solid #000000;" class="td_simple">Received from <?php echo $InstallersData->installer_name;?>.</td>
