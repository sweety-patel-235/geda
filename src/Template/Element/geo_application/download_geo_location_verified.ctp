        ...
        <div class="container">
            ...
            <div id="content" class="mainbox">
                ...
                <table class="td_simple" width="100%" style="border:1px solid #000000;border-collapse: collapse;margin-top:20px;">
                    ...
                    <tr>
                        <td style="vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: center;" class="td_bold" colspan="10">WTG COORDINATE VERIFICATION REPORT</td>
                    </tr>
                    <tr>
                        <td style="width:10%;vertical-align: top;border-bottom: 1px solid #000000;text-align: left;padding-left:5px;" class="td_bold" colspan="7">Developer Name & Address :  <?php echo $developer_name ?><br><?php echo $developer_address ?></td>

                        <td style="vertical-align: top; border-bottom: 1px solid #000000;text-align: right;padding-right:5px;" class="td_bold" colspan="3"> Date : <?php echo date('d-M-Y H:i:s',strtotime($wtg_verified_date)); ?></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;padding-left:5px;" class="td_bold" colspan="10">Nos. of WTG :   <?php echo count($geo_application_data_array) ?></td>
                    </tr>
                    <tr>
                    ...
                    foreach ($geo_application_data_array as $key => $value) { 
                        ...
                        <tr>
                            ...
                            <td style="width:5%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: left;" class="td_simple"><?php echo $value['wtg_location'];?></td>
                            <td style="width:5%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: left;" class="td_simple"><?php echo $value['geo_village'];?></td>
                            ...
                            <td style="width:10%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: left;" class="td_simple"><?php echo $wtg_make_name;?>/ <?php echo $value['wtg_capacity'];?>/ <?php echo $value['wtg_rotor_dimension'];?>/ <?php echo $value['wtg_hub_height'];?></td>
                            <td style="width:10%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: center;" class="td_simple">
                                ...
                                if(!empty($value['geo_application_clashed_data']['clashed_for'])){
                                    ...
                                    if($value['approved'] == 1){
                                        ...
                                        echo 'Rejected';
                                        $value['comment'] =$value['geo_application_reject_log']['reject_reason'];
                                    }
                                }
                        ...
                        <tr>
                           <!--  <td style="width:5%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: left;" class="td_simple" >Comment :</td> -->
                            <td style="width:5%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: left;" class="td_simple" colspan="9">Comment :- <?php echo !empty($value['comment'])?$value['comment']:'NA';?></td>
                        </tr>
                   <?php $counter++; }  ?>
                </table>
