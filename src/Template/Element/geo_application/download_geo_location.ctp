            ...
            <div id="content" class="mainbox">
                ...
                <table class="td_simple" width="100%" style="border:1px solid #000000;border-collapse: collapse;margin-top:20px;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top; border-bottom: 1px solid #000000;text-align: right;padding-right:5px;" class="td_bold" colspan="3"> Date : <?php echo date('d-M-Y',strtotime($geo_application_data->approved_date)); ?></td>
                    </tr>
                    <tr>
                    ...
                    foreach ($geo_application_data_array as $key => $value) { 
                        ...
                        <tr>
                           <!--  <td style="width:5%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: left;" class="td_simple" >Comment :</td> -->
                            <td style="width:5%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: left;" class="td_simple" colspan="9">Comment :- <?php echo !empty($value['comment'])?$value['comment']:$value['geo_application_reject_log']['reject_reason'];?></td>
                        </tr>
                   <?php $counter++; }  ?>
                </table>
