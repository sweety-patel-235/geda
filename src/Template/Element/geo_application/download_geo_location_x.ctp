                 ...
                 <table class="td_simple" width="100%" style="text-align: center;border:1px solid #000000;border-collapse: collapse;margin-top:20px;">
                    ...
                    foreach ($geo_application_data_array as $key => $value) { 
                            ...
                            if (array_key_exists($key, $district)) {
                             ...
                             $keyid = $value['id'];
                             if (array_key_exists($keyid, $geo_application_clashed_data)) {
                                // If the key exists, show its value
                                $clashedfor = $geo_application_clashed_data[$keyid];
                        ...
                        <tr>
                            ...
                            <td style="width:10%; vertical-align: top;border-right: 1px solid #000000;border-bottom: 1px solid #000000;text-align: center;" class="td_simple">
                                ...
                                if($value['approved'] == 1){
                                    ...
                                    if (!empty($clashedfor) && $clashedfor == 1){ 
                                       echo 'clashing';
                                    } elseif (!empty($clashedfor) && $clashedfor == 2){
                                            echo 'hgfhgf  clashing';
                                    }else{
                                        echo ' no action';
                                    }
                                }
