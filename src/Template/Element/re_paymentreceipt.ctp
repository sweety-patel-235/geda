							...
							<table style="border:1px solid #000000;border-collapse: collapse;" cellpadding="2" width="100%">
								<tr>
									...
									<td style="vertical-align: top;width:33%;line-height: 15px;border-bottom: 1px solid #000000;padding-left: 3px;" > 
									   <!-- <?php echo $payment_data->payment_dt;?> -->
							...
							<table style="border:1px solid #000000;border-collapse: collapse;" cellpadding="5" width="100%">
								...
								<tr>
									...
									<td style="vertical-align: top;width:65%;border-right: 1px solid #000000;border-bottom: 1px solid #000000;" class="td_simple">
										Application Processing Fees - <?php echo $Applications->application_category['category_name'];?> (Provisional)
									</td>
									<td style="width:25%; vertical-align: top;border-bottom: 1px solid #000000;text-align: center;" class="td_simple">
										<?php echo $Applications->application_fee;?>
									</td>
								</tr>
								<?php
								$cgst           = ($Applications->gst_fees/2);
								$total_amount   = $Applications->application_total_fee;
								$tds_deduction 	= $Applications->tds_deduction;
								?>
								<tr>
								...
								<?php if($Applications->tds_deduction>0) { ?>
									<tr>
										...
										<td style="width:25%; vertical-align: top;border-bottom: 1px solid #000000;text-align: center;" class="td_simple">
											<?php echo $Applications->tds_deduction;?>
										</td>
									</tr>
								<?php } ?>
								<tr>
									<td colspan="2" style="border-bottom: 1px solid #000000;" class="td_simple">Net Payment Received from <?php echo $Applications->name_of_applicant;?> for application processing fees for Provisional Registration of <?php echo ($Applications->application_type == 2) ? $Applications->pv_capacity_ac : $Applications->total_capacity;?> MW <?php echo $Applications->application_category['category_name'];?> project.</td>
								...
								<tr>
									<td colspan="3" style="" class="td_simple">The fees paid is non-refundable.</td>
								</tr>
								<tr>
