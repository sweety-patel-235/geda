        ...
        <div class="portlet box blue-madison noborder">
            <table class="table table-striped table-bordered table-hover custom-greenhead frontlayout-activesort" id="table-example">
                <thead>
                    <tr>
                        <th class="">Sr.</th>
                        <th class="" style="text-align: left;">DISTRICT</th>
                        <th class="">No. of Meter Installed</th>
                        <th class="">Total capacity (kW)</th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
                    ...
                    $srNo   = 1;
                        foreach($arrCountData as $key=>$val)
                        {
                            ...
                            <tr>
                                <td><?php echo $srNo;?></td>
                                <td style="text-align: left;"><?php echo !empty($key) ? $key : 'No District';?></td>
                                <td><?php echo $arrCountData[$key];?></td>
                                <td><?php echo !empty($arrCapacityData[$key]) ? number_format($arrCapacityData[$key],3,'.','') : '0.000';?></td>
                            </tr>
                            <?php
                            $total_application  += $arrCountData[$key];
                            $total_capacity     += $arrCapacityData[$key];
                            $srNo++;
                        }
                    ?>
                    <tr>
