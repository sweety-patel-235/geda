                ...
                <tbody>
                    ...
                    foreach($arrSubdivision as $subdivision)
                    {
                        ...
                        <tr>
                            ...
                            <td><?php echo $subdivision->address2;?></td>
                            <?php
                            foreach($arrSubDivStage as $key_stag=>$stage)
                            {
                                $total_records[$key_stag]    += $final_data[$subdivision->address2][$key_stag];
                                ?>                 
                                <td><?php echo empty($final_data[$subdivision->address2][$key_stag]) ? '0' : $final_data[$subdivision->address2][$key_stag];?></td>
                                <?php
                            }
                            ?>
                        </tr>
