            ...
            <td>
              <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td align="left" class="long-text links-color" style="text-align: left; font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f;">
                        <p style="margin: 1em 0px;margin-bottom: 10px;margin-top: 10px;">
                          Your application for a Rooftop Solar PV (RTPV) system has been submitted successfully. The installer selected by you is <?php echo $INSTATTER_NAME;?>. Thank you.
                        </p>
              </td>
            </tr></tbody></table>
          </td>
          ...
          <td>
            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tbody>
                ...
                <tr>
                  <td align="left" class="long-text links-color" style="text-align: left; font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f;">
                    Rooftop Solar PV Programme of GEDA
                  </td>
                </tr>
                <!--  <tr>
                  <td align="left" class="long-text links-color" style="text-align: left; font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f;">
                ...
                <tr>
                  <td align="left" class="long-text links-color" style="text-align: left; font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f;">
                      <i>Note: This message is not an approval for sanction of any financial assistance and capacity of RTPV system. This is only to inform the Applicant that the Application is successfully submitted at the Portal.</i>
                  </td>
                </tr>
