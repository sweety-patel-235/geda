...
<!--[if (gte mso 9)|(lte ie 8)]><table align="center" border="0" cellspacing="0" cellpadding="0" width="570"><tr><td align="center" valign="top"><![endif]-->
        ...
        Welcome to the AHA! Solar. We are excited you’re here, using our revolutionary tool and hope you are having the best of it. The summary of the site survey for the <?php echo $PROJECT_NAME;?> dated <?php echo date('d M Y');?> is attached herein.
                        </p>
              </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td align="left" class="long-text links-color" style="text-align: left; font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f;"><p style="margin: 1em 0px;margin-bottom: 10px;margin-top: 10px;">We strive to make your AHA! App your one stop for all your solar PV installation related worries. Kindly share your experiences and suggestions; we love to learn from your feedback at AHA!  Sincerely,</p></td></tr>
          </tbody></table>
          </td>
        </tr>
      </tbody>
          ...
          <td>
            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tbody>
                ...
                <tr>
                  <td align="left" class="long-text links-color" style="text-align: left; font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f;">
                    <small>AHA! Rooftop Solar Helper Team</small>
                  </td>
                </tr>
