						...
						<tbody>
							<tr>
								...
								<p style="margin: 1em 0px;margin-bottom: 10px;margin-top: 10px;">
									Delete request for the Application No. - <?php echo $application_no;?> of the Rooftop Solar PV (RTPV) system has been rejected by GEDA. 
								</p>
								<p style="margin: 1em 0px;margin-bottom: 10px;margin-top: 10px;">
									Reason for rejection : <?php echo $REASON_REJECTION;?>
								</p>
								<p style="margin: 1em 0px;margin-bottom: 10px;margin-top: 10px;">
									For more details, kindly check at https://geda.ahasolar.in. Thank you.
								</p>
								</td>
							</tr>
						</tbody>
