...
<div class="container-fluid applications-from">
	<div class="row col-md-12">
		<h4 class="<?php echo $titleClass;?> mb-sm mt-sm"><strong>Application</strong> Geo Cordinates </h4>
						...
						<td>
							<div class="col-md-6 m-2">
								<fieldset class="fieldset">
									<legend class="fieldset-legends legend-width">Add the geo Cordinates</legend>
									<div class="col-md-12">
										<?php
										...
										<div class="row mt-xlg">
											<div class="col-md-12">
												<lable class="col-md-4">Total Cordinates can Add</lable>
											<div class="col-md-4">
												<?php echo $this->Form->input('geo_cordinate_file', array('label' => false,'class'=>'form-control','placeholder'=>'','id'=>'GeoFile','value'=>$total_wtg_application ,'readonly'=>'readonly')); ?>
											</div>
			...
			<div class="table table-responsive table-bordered noborder" >
				 ...
				 <table id= "tbl_wind_info" class="table table-striped table-bordered table-hover custom-greenhead" >
				  	...
				  	<tr class="thead-dark">
				  		...
				  		<th colspan="19" style="text-align:center;" >Details of WTG Coordinate Verification </th>
				  		</thead>
				  	</tr>
				  	<tr >
				  		...
				  		<td rowspan = "2"  style="text-align:center;" >Date  of Validity </td>
					  		...
					  		foreach ($geo_application_payment_done as $key => $value) {?>
			                	...
			                	?>
									<tr>
								  		...
								  		<td style="text-align:center;" ><?php echo $this->Form->input('wtg_location',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_location_'.$counter,'value'=>$geo_application_payment_done[$key]['wtg_location'])); ?></td>
								  		...
								  		<td style="text-align:center;" ><?php echo $this->Form->input('wtg_validity_date', array('label' => false ,'div'=>false,'type'=>'text' , 'class'=>'form-control form-control-inline wtg_validity_date','id'=>'wtg_validity_date_'.$counter,'placeholder'=>'Validity Date','autocomplete'=>'off','value'=>$geo_application_payment_done[$key]['wtg_validity_date'])); ?></td>
								  		<!--<td style="text-align:center;" ><?php /* echo $this->Form->input('type_of_deed', array('label' => false,'type'=>'file','style'=>'width: 100px;','class'=>'form-control','readonly'=>'readonly','placeholder'=>'Upload','id'=>'type_of_deed_'.$counter,'value'=>$geo_application_payment_done[$key]['type_of_deed'])); ?>
									  		<div class="row" style="margin-right: 2px;margin-left: -4px;">
												<div class="col-md-12"  id="type_of_deed_<?php echo $counter ?>-file-errors"></div>
											</div>
								  		</td>
					  	...
					  	foreach ($geo_application_data as $key => $value) {?>
			                ...
			                ?>
				  			...
				  			<tr>
						  		...
						  		<td style="text-align:center;" ><?php echo $this->Form->input('wtg_location',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_location_'.$counter,'value'=>$geo_application_data[$key]['wtg_location'])); ?></td>
						  		...
						  		<td style="text-align:center;" ><?php echo $this->Form->input('wtg_validity_date', array('label' => false ,'div'=>false,'type'=>'text' , 'class'=>'form-control form-control-inline wtg_validity_date','id'=>'wtg_validity_date_'.$counter,'placeholder'=>'Validity Date','autocomplete'=>'off','value'=>$geo_application_data[$key]['wtg_validity_date'])); ?></td>
						  		<!--<td style="text-align:center;" ><?php /*echo $this->Form->input('type_of_deed', array('label' => false,'type'=>'file','style'=>'width: 150px;','class'=>'form-control','placeholder'=>'Upload','id'=>'type_of_deed_'.$counter,'value'=>$geo_application_data[$key]['type_of_deed'])); ?>
									  		<div class="row" style="margin-right: 2px;margin-left: -4px;">
												<div class="col-md-12"  id="type_of_deed_<?php echo $counter ?>-file-errors"></div>
											</div>
						  		</td>
						  	...
						  	<?php }else { ?>
						  		<td style="text-align:center;display: none;" class="N_data<?php echo $counter?>"><?php echo $this->Form->input('wtg_make_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_make_n_'.$counter,'value'=>$geo_application_data[$key]['wtg_make'])); ?> 
							  		&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<div class="row" style="margin-right: 2px;margin-left: -4px;">
											<div class="col-md-12"  id="wtg_file_<?php echo $counter ?>-file-errors"></div>
									</div></span>
									...
									&nbsp;&nbsp;
									<a href="<?php echo URL_HTTP.'app-docs/wtg_file/'.encode($geo_application_data[$key]['id']); ?>" target="_blank"><i class="fa fa-file">View Wtg File</i></a>
						  			<?php } ?>
								</td>
						  		<td style="text-align:center;display: none;" class="N_data<?php echo $counter?>"><?php echo $this->Form->input('wtg_model_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_model_n_'.$counter,'value'=>$geo_application_data[$key]['wtg_model'])); ?>  </td>
						  		<td style="text-align:center;display: none;" class="N_data<?php echo $counter?>"><?php echo $this->Form->input('wtg_capacity_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_capacity_n_'.$counter,'value'=>$geo_application_data[$key]['wtg_capacity'])); ?>  </td>
						  		<td style="text-align:center;display: none;" class="N_data<?php echo $counter?>"><?php echo $this->Form->input('wtg_rotor_dimension_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_rotor_dimension_n_'.$counter,'value'=>$geo_application_data[$key]['wtg_rotor_dimension'])); ?>  </td>
						  		<td style="text-align:center;display: none;" class="N_data<?php echo $counter?>"><?php echo $this->Form->input('wtg_hub_height_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_hub_height_n_'.$counter,'value'=>$geo_application_data[$key]['wtg_hub_height'])); ?>  </td>
						  	<?php } ?>
						  		<td style="text-align:center;">
		...
		<div class="modal-dialog">
			<div class="modal-content modal-lg">
				...
				<div class="modal-body">
					...
					<?php echo $this->Form->input('application_type',['application_type'=>'application_type','label' => false,'type'=>'hidden','value'=>$Applications->application_type]); ?>
						<div class="row">
							<div class="col-md-3">
								<lable>WTG Location </lable>
								<?php echo $this->Form->input('wtg_location',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_location_'.$counter)); ?>
								
							</div>
							<div class="col-md-3">
								<lable>Type of Land </lable>
								<?php echo $this->Form->select('type_of_land', $type_of_land, array('label' => false, 'class' => 'form-control','empty' =>'-Select Type-', 'id' => 'type_of_land_'.$counter)); ?>
								
							</div>
							<div class="col-md-3">
								<lable>Land Survey No. </lable>
								<?php echo $this->Form->input('land_survey_no',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'land_survey_no_'.$counter)); ?>
								
							</div>
							<div class="col-md-3">
								<lable>Land Area </lable>
								<?php echo $this->Form->input('land_area',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'land_area_'.$counter)); ?>
						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<?php echo $this->Form->select('geo_district', $district, array('label' => false, 'class' => 'form-control','id' => 'geo_district_'.$counter, 'empty' => '-Select District-')); ?>
								
							</div>
							<div class="col-md-3">
								<lable>Village </lable>
								<?php echo $this->Form->input('geo_village',array("type" => "text",'label' => false,'class'=>'form-control onlycharacter','id' => 'geo_village_'.$counter)); ?>
								
							</div>
							<div class="col-md-3">
								<lable>Taluka </lable>
								<?php echo $this->Form->input('geo_taluka',array("type" => "text",'label' => false,'class'=>'form-control onlycharacter','id' => 'geo_taluka_'.$counter)); ?>
								
							</div>
							<div class="col-md-3">
								<lable>Date of Validation </lable>
						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<?php echo $this->Form->input('x_cordinate',array("type" => "text",'label' => false,'class'=>'form-control','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{3}).+/g, '$1');",'id' => 'x_cordinate_'.$counter)); ?>
								
							</div>
							<div class="col-md-3">
								<lable>UTM Northing</lable>
								<?php echo $this->Form->input('y_cordinate',array("type" => "text",'label' => false,'class'=>'form-control','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/(\.\d{3}).+/g, '$1');",'id' => 'y_cordinate_'.$counter)); ?>
						...
						<div class="row Y_data">
							<div class="col-md-3">
								...
								<?php echo $this->Form->select('wtg_make', $type_manufacturer_wind, array('label' => false, 'class' => 'rfibox wtg_make_cls', 'empty' => '- Select -', 'id' => 'wtg_make_'.$counter, 'onChange' => 'javascript:changeMake('.$counter.')')); ?>
								
							</div>
							<div class="col-md-3">
								<lable>WTG Model </lable>
								<?php echo $this->Form->select('wtg_model', [], array('label' => false, 'class' => 'rfibox wtg_model_cls', 'empty' => '- Select -', 'id' => 'wtg_model_'.$counter, 'onChange' => 'javascript:changemodel('.$counter.')')); ?> 
								
							</div>
							<div class="col-md-3">
								<lable>WTG Capacity </lable>
								<?php echo $this->Form->select('wtg_capacity', [], array('label' => false, 'class' => 'rfibox wtg_capacity_cls', 'empty' => '- Select -', 'id' => 'wtg_capacity_'.$counter,'onChange' => 'javascript:changeWindRowCapacity(this)')); ?>
								
							</div>
							<div class="col-md-3">
								<lable>WTG Rotor Dimension </lable>
								<?php echo $this->Form->select('wtg_rotor_dimension', [], array('label' => false, 'class' => 'rfibox wtg_rotor_dimension_cls', 'empty' => '- Select -', 'id' => 'wtg_rotor_dimension_'.$counter)); ?>
						...
						<div class="row Y_data">
							...
							<div class="col-md-3" style="margin-top:10px;margin-bottom:10px;">
								...
								<?php echo $this->Form->select('wtg_hub_height', [], array('label' => false, 'class' => 'rfibox wtg_hub_height_cls', 'empty' => '- Select -', 'id' => 'wtg_hub_height_'.$counter)); ?>
						...
						<div class="row N_data" style="display: none;">
							<div class="col-md-3">
								<lable>WTG Make </lable>
								<?php echo $this->Form->input('wtg_make_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_make_n_'.$counter)); ?> 
							</div>
							
							<div class="col-md-3">
								<lable>WTG Model </lable>
								<?php echo $this->Form->input('wtg_model_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_model_n_'.$counter)); ?>
							</div>
							<div class="col-md-3">
								<lable>WTG Capacity </lable>
								<?php echo $this->Form->input('wtg_capacity_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_capacity_n_'.$counter)); ?> 
							</div>
							<div class="col-md-3">
								<lable>WTG Rotor Dimension </lable>
								<?php echo $this->Form->input('wtg_rotor_dimension_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_rotor_dimension_n_'.$counter)); ?>  	
							</div>
						...
						<div class="row N_data" style="display: none;">
							<div class="col-md-3">
								<lable>WTG Hub Height </lable>
								<?php echo $this->Form->input('wtg_hub_height_n',array("type" => "text",'label' => false,'class'=>'form-control','id' => 'wtg_hub_height_n_'.$counter)); ?>  
							</div>
							
							<div class="col-md-3">
								<lable>WTG File </lable>
								<?php echo $this->Form->input('wtg_file', array('label' => false,'type'=>'file','class'=>'form-control','placeholder'=>'Upload File','id'=>'wtg_file_'.$counter)); ?>
								<div class="row" style="margin-right: 2px;margin-left: -4px;">
					...
					<div class="row">
						<div class="col-md-2">
							<?php echo $this->Form->input('Submit',['type'=>'button','label'=>false,'class'=>'btn btn-primary AddApplication_btn','data-form-name'=>'AddApplicationForm'.$counter]); ?>
						</div>
					</div>
					<?php
					echo $this->Form->end(); ?>
...
<script type="text/javascript">
	...
	<?php $counter = 1;
	foreach ($geo_application_payment_done as $key => $value) {?>
		$('#wtg_location_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#type_of_land_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#land_survey_no_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#land_area_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#geo_village_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#geo_taluka_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#geo_district_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_validity_date_<?php echo $counter; ?>').attr('disabled', 'disabled');

		$('#zone<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#x_cordinate_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#y_cordinate_<?php echo $counter; ?>').attr('disabled', 'disabled');

		$('#rlmm<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_make_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_make_n_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_model_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_model_n_<?php echo $counter; ?>').attr('disabled', 'disabled');

		$('#wtg_capacity_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_capacity_n_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_rotor_dimension_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_rotor_dimension_n_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_hub_height_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_hub_height_n_<?php echo $counter; ?>').attr('disabled', 'disabled');
		$('#wtg_file_<?php echo $counter; ?>').attr('disabled', 'disabled');
	<?php $counter++; 
}	?>
...
$('.wtg_validity_date').datepicker({format:'dd-mm-yyyy',autoclose: true});	
// $(document).ready(function(){
...
function ValidateRow(index) {
	//$("#tbl_wind_info > tbody  > tr").each(function(index, tr) {
		...
		if (x_cordinate < 19.00 || x_cordinate >  24.82) {
			...
			$("#x_cordinate_" + index).parent().append('<div class="help-block x_cordinate_error_msg_cls" id="x_cordinate_error_msg_' + index + '">X-Coordinate Between 19.00 to 24.82</div>');
		}
