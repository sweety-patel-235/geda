...
<div class="container applay-online-from">
	...
	<div class="tabs tabs-bottom tabs-simple nk_tabs">
		<a href="#desc_applicant" data-toggle="collapse" onclick="javascript:changeClick('id_desc_applicant','hide');" id="id_desc_applicant" ><h4>Description of Applicant</h4></a>
		...
		<a href="#contact_details" data-toggle="collapse"><h4>Contact Details</h4></a>
		<div id="contact_details" <?php if(empty($ApplyOnlineErrors)) { ?> aria-expanded="false" class="collapse" <?php } ?>>
			<div class="form-group">
				<div class="col-md-4">
		...
		<a href="#discom_details" data-toggle="collapse"><h4>Details of Sub-station notified by the Discom (where the proposed land is available within 5 km radius)</h4></a>
		<div id="discom_details" <?php if(empty($ApplyOnlineErrors)) { ?> aria-expanded="false" class="collapse" <?php } ?>>
			<div class="form-group">
				<?php 
				$error_class_type 	= '';
				$error_message 		= '';
		...
		<a href="#land_details" data-toggle="collapse"><h4>Land Details</h4></a>
		<div id="land_details" <?php if(empty($ApplyOnlineErrors)) { ?> aria-expanded="false" class="collapse" <?php } ?>>
			<div class="form-group">
				<div class="col-md-4">
		...
		<a href="#offered_capacity" data-toggle="collapse"><h4>Proposed Solar PV Power Plant capacity (in MW)</h4></a>
		<div id="offered_capacity" <?php if(empty($ApplyOnlineErrors)) { ?> aria-expanded="false" class="collapse" <?php } ?>>
			<div class="form-group">
				<div class="col-md-4">
		...
		<a href="#distnace_substation" data-toggle="collapse"><h4>Distance between the Proposed land and Sub-station notified by the Discom</h4></a>
		<div id="distnace_substation" <?php if(empty($ApplyOnlineErrors)) { ?> aria-expanded="false" class="collapse" <?php } ?>>
			<div class="form-group">
				<div class="col-md-4">
		...
		<a href="#option_available" data-toggle="collapse"><h4>Options available to the applicants for installation of Solar Power Plants</h4></a>
		<div id="option_available" <?php if(empty($ApplyOnlineErrors)) { ?> aria-expanded="false" class="collapse" <?php } ?>>
		...
		<a href="#installer_details" data-toggle="collapse"><h4>Details of Solar PV Installer (GEDA Installers)</h4></a>
		<div id="installer_details" <?php if(empty($ApplyOnlineErrors)) { ?> aria-expanded="false" class="collapse" <?php } ?>>
			<div class="form-group">
				<?php 
				$error_class_type 	= '';
				$error_message 		= '';
		...
		<a href="#fees" data-toggle="collapse"><h4>Application Fees</h4></a>
		<div id="fees" <?php if(empty($ApplyOnlineErrors)) { ?> aria-expanded="false" class="collapse" <?php } ?>>
			<div class="form-group">
				<div class="col-md-4">
