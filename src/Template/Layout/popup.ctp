...
<head>
	...
	<link rel="shortlink" href="http://www.ahasolar.in/">
	<link rel="search" type="application/opensearchdescription+xml" href="http://www.ahasolar.in/" title="<?php echo (isset($page_title)?$page_title:PRODUCT_NAME); ?>">
	<link rel="shortcut icon" href="https://s.ytimg.com/yts/img/favicon-vflz7uhzw.ico" type="image/x-icon">  
	<link rel="icon" href="http://www.ahasolar.in/img/frontend/logo-sticky.png" sizes="50x50">
	<meta name="theme-color" content="#e62117">       
	
	<meta property="og:site_name" content="<?php echo (isset($page_title)?$page_title:PRODUCT_NAME); ?>">
	<meta property="og:url" content="ttp://www.ahasolar.in/">
	<meta property="og:title" content="<?php echo (isset($page_title)?$page_title:PRODUCT_NAME); ?>">
	<meta property="og:image" itemprop="image" content="http://www.ahasolar.in/img/frontend/logo-sticky.png">
	...
	<meta name="twitter:site" content="http://www.ahasolar.in">
	<meta name="twitter:url" content="http://www.ahasolar.in/">
	<meta name="twitter:title" content="<?php echo (isset($page_title)?$page_title:PRODUCT_NAME); ?>">
	<meta name="twitter:description" content=" ">
	<meta name="twitter:image" itemprop="image" content="http://www.ahasolar.in/img/frontend/logo-sticky.png">
	<meta name="twitter:app:name:googleplay" content="AHA Solar">
	<meta name="twitter:app:id:googleplay" content="com.energy.ahasolar">
	<meta name="twitter:app:url:googleplay" content="ttps://play.google.com/store/apps/details?id=com.energy.ahasolar&amp;feature=applinks">
