<?php
    ...
    if(isset($resultArr['monthChart']) && !empty($resultArr['monthChart'])) {
        $monthChartData =  json_decode(str_replace('\'','"',$resultArr['monthChart']));
    ...
    if(isset($resultArr['yearChart']) && !empty($resultArr['yearChart'])) {
        $yearChartData =  json_decode(str_replace('\'','"',$resultArr['yearChart']));
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                <?php echo $customerData->area; ?>  <?php echo isset($areaTypeArr[$customerData->area_type])?$areaTypeArr[$customerData->area_type] : ""; ?>
                                </div>
                            </div>
                        </div>
					</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                <?php if(isset($custTypeArr[$customerData->customer_type])) { echo $custTypeArr[$customerData->customer_type]; } ?>
                                </div>
                            </div>
                        </div>
					</div>
