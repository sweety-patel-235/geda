        ...
        <div class="container">
            ...
            <div class="mainbox">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <span>
                                    <?php 
                                        if (isset($project->estimated_cost_subsidy) && $project->estimated_cost_subsidy > 0) {
                                            echo _FormatNumberV2(!empty($project->estimated_cost_subsidy)?round($project->estimated_cost_subsidy/100000,2):0);
                                        } else {
                                            echo 0;
                                        }
                                    ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <span>
                                    <?php 
                                        if (isset($monthly_saving) && $monthly_saving > 0) {
                                            echo _FormatNumberV2(($monthly_saving/12));
                                        } else {
                                            echo 0;
                                        }
                                    ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <span>
                                    <?php 
                                    if(isset($monthly_saving)) {
                                        echo _FormatNumberV2($monthly_saving);
                                    } else {
                                        echo 0;
                                    } ?>
                                    </span></td>
                            </tr>
                            <?php if(strtolower($project->custtype['para_value'])=='residential') { ?>
                            <tr>
                                <td>H.</td>
                                <td>Total Subsidy</td>
                                <td>Rs. in Lacs/ kW</td>
                ...
                <div>
                    ...
                    <br/>
                    <?php 
                        $solar_ratio = (isset($solar_ratio)?$solar_ratio:0);
                        if ($solar_ratio > 0) {
                            echo "<p>The recommended size of the rooftop solar PV system will cover ".$solar_ratio."% of your electricity usage.</p>";
                        }
                    ?>
                </div>
                ...
                <table class="nk_table">
                    ...
                    <tr>
                        ...
                        <td class="last">Homes Powered for One Year </td>
                    </tr>
                    <tr>
                ...
                <p>An approximate cost of the RSPVS will be around <span >Rs. <?php echo _FormatNumberV2($project->estimated_cost * 100000); ?> /- </span> with a payback of <span ><?php echo round($project->payback,2); ?></span> years considering subsidy. <?php if(strtolower($project->custtype['para_value'])=='residential') {?> You are eligible for a subsidy <span >30% on capital cost of RSPVS</span> from Government of India.<?php }?></p>
                <p>If you are a profit making Company then you can also avail tax benefit of 40% Accelerated Depreciation for your RSPVS. This is applicable only for Industrial or Commercial User.</p>
                ...
                <div class="mainboxlast">
                    ...
                    <section class="footer-section">
                            <table class="t4">
                                <tr>
                                    ...
                                    <td class="align-center" width="100%">Knowledge Partner</td>
                                </tr>
                                <tr>
                                    <!--td class="align-center">
                                        <img src="images/poweredby.png" class="img-responsive center-block">
                                    </td-->
                                    <td class="align-center">
                                        <img src="images/germi.png" class="img-responsive center-block">
                                    </td>
                                </tr>
                            </table>                         
                    </section>
                    ...
                    <div class="customfooter">
                        ...
                        <small>03, GOPI BUNGLOWS, OPP. BHAGYAODAYA ROW, NR. VISHWASCITY-II, GHATLODIA, AHMEDABAD 380061, GUJARAT INDIA.</small><br />
                        Phone: +91 966 297 2012 ; Email: info@ahasolar.in<br/>
