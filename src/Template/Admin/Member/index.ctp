<?php if($AjaxRequest=='0'){?>
	<?php echo $this->Form->create('Members',array("id"=>"formmain","url"=>ADMIN_PATH."/customers/index","name"=>"searchAdminuserlist",'class'=>'form-horizontal form-bordered',"autocomplete"=>"off")); ?>
	<div class="row">
		<div class="col-md-12">
			<div class="portlet box blue-madison">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-list-ul"></i>Members List
					</div>
					<div class="tools">
					...
					<div class="actions">
						...
						if($blnAddAdminuserRights) {
                        	echo $Userright->linkAddMember(constant('WEB_URL').constant('ADMIN_PATH').'member/manage','<i class="fa fa-plus"></i> Add Member','','alt="addRecord" class="btn green btn-border"');
                       	}
                       	?>
                    </div>
				</div>
					...
					<?php echo $this->Form->hidden('Direction',array("value"=>$Direction,"id"=>"Direction")); ?>
						<div class="form-body">
							<div class="form-group">
								...
								<div class="col-md-3">
									<?php echo $this->Form->input('Members.id', array('label' => false ,'size'=>5,'div'=>false,'type'=>'text','class'=>'form-control form-control-inline input-medium date-picker','id'=>'customers-id'));?>
								</div> 
								<label class="control-label col-md-1">Name</label>
								<div class="col-md-3">
									<?php echo $this->Form->input('Members.name', array('label' => false ,'size'=>16,'div'=>false,'type'=>'text','class'=>'form-control form-control-inline input-medium date-picker','id'=>'customers-name'));?>
								</div>
								<label class="control-label col-md-1">Email</label>
								<div class="col-md-3">
									<?php echo $this->Form->input('Members.email', array('label' => false ,'size'=>5,'div'=>false,'type'=>'text','class'=>'form-control form-control-inline input-medium date-picker','id'=>'customers-email'));?>
								</div> 
							</div>
							<div class="form-group">
								<label class="control-label col-md-1">Status</label>
								<div class="col-md-3">
									<?php echo $this->Form->select('Members.status', array(''=>'Select','1'=>'Active','I'=>'Inactive'), array('label' => false ,'div'=>false,'type'=>'text', 'class'=>'form-control form-control-inline input-medium date-picker','id'=>'customers-status'));?>
								</div>
								<label class="control-label col-md-1">Mobile</label>
								<div class="col-md-3">
									<?php echo $this->Form->input('Members.mobile', array('label' => false ,'size'=>5,'div'=>false,'type'=>'text','class'=>'form-control form-control-inline input-medium date-picker','id'=>'customers-mobile'));?>
								</div> 
								<label class="control-label col-md-1">City</label>
								<div class="col-md-3">
									<?php echo $this->Form->input('Members.city', array('label' => false ,'size'=>16,'div'=>false,'type'=>'text' ,'options'=>$arrUserType, 'class'=>'form-control form-control-inline input-medium date-picker','id'=>'customers-city'));?>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-1">Date</label>
								<div class="col-md-3">
									<?php echo $this->Form->select('Members.search_date',array(''=>'Select','Members.created'=>'Created Date','Members.last_login_date'=>'Last Login Date'), array('label' => false ,'id'=>'SearchDate','div'=>false,'type'=>'text','onchange'=>"resetdates();",'class'=>'form-control form-control-inline input-medium date-picker'));?>
								</div>
								<label class="control-label col-md-1">Period</label>
								<div class="col-md-3">
									<?php echo $this->Form->select('Members.search_period',$period, array('label' => false ,'div'=>false,'onChange'=>'resetcustomdates(false);', 'class'=>'form-control form-control-inline input-medium','id'=>'SearchPeriod'));?>
								</div>
								<label class="control-label col-md-1">From Date</label>
								<div class="col-md-3">
									<?php echo $this->Form->input('Members.DateFrom', array('label' => false ,'div'=>false,'type'=>'text','class'=>'form-control form-control-inline input-medium','id'=>'DateFrom')); ?>
								</div> 
							</div>
							<div class="form-group">	
								<label class="control-label col-md-1">To Date</label>
								<div class="col-md-3">
									<?php echo $this->Form->input('Members.DateTo', array('label' => false ,'div'=>false,'type'=>'text' , 'class'=>'form-control form-control-inline input-medium','id'=>'DateTo')); ?>
								</div>
							</div>
