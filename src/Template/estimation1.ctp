    ...
    <body id="pdf-header" onload="pagination()">
        <div class="container">
            ...
            <div class="mainbox">
                ...
                <section class="yellowh1">
                    <h1>Introduction of AHA! App</h1>
              ...
              <!--   <hr> -->
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-6 nopadding">
                        <img src="images/map.png" class="img-responsive width100">
                    </div>
                    <div class="col-lg-6 col-sm-6 col-xs-6 nopaddingright">
                        <div class="border-top">
                            <p><b>Input by</b> <span class="red">"Name of User"</span></p>
                            <p class="green">Type of Customer</p>
                            <p class="red">"<.......>"</p>
                            <p class="green">Average Energy Consumption</p>
                            <p>"<.......> kW"</p>
                            <p class="green">Average Monthly Bill</p>
                            <p><span class="green">Rs.</span><span class="red">"<.......>"</span> per month</p>
                            <p class="green">Type of Back-up power used</p>
                            <p class="red">"<.......>"</p>
                            <p class="green">Back-up Usage (if applicable)</p>
                            <p><span class="red">"<.......>"</span>&nbsp;<span>hours per day</span></p>
                        </div>
                    </div>
                </section>
...
<!--              <hr>-->
                <section class="yellowh1">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-6 nopaddingright">
                        <div class="border-top">
                            ...
                            <p class="green">0.35% of Project Cost</p>
                            <p class="green">Depreciation</p>
                            <p>First 10 years– 6%</p>
                            <p>Next 15 years – 2%</p>
                ...
                <section class="yellowh1">
                    ...
                    <div class="col-lg-8 col-sm-8 col-xs-8 nopadding">
                        <img src="images/chart.png" class="img-responsive width100">
                    </div>
                    <div class="col-lg-4 col-sm-4 col-xs-4 nopaddingright">
                        <div class="border-top">
                            <p><b>QUARTER 1</b></p>
...
<!--                <hr>-->
                ...
                <section class="yellowh1">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12 nopadding">
                        <img src="images/flow.png" class="img-responsive center-block">
...
<!--                <hr>-->
                ...
                <section class="yellowh1">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12 nopadding">
                        <img src="images/chart1.png" class="img-responsive center-block">
                    </div>
                </section>
                ...
                <section class="yellowh1">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12 nopadding">
                        <img src="images/chart2.png" class="img-responsive center-block">
                    </div>
                </section>
                ...
                <section class="yellowh1">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12 nopadding">
                        <table class="t3">
                            <tr>
                                <td class="border-top-yellow" valign="top"><b>Installer 1</b></td>
                                <td valign="top">:</td>
                                <td class="border-top-yellow">
                                    <p>&lt; Name of Installer &gt;</p>
                                    <p>&lt; Address Line 1 &gt;</p>
                                    <p>&lt; Address Line 2 &gt;</p>
                                    <p>&lt; Mobile No &gt;</p>
                                </td>
                            ...
                            <tr>
                                <td class="border-top-yellow" valign="top"><b>Installer 2</b></td>
                                <td valign="top">:</td>
                                <td class="border-top-yellow">
                                    <p>&lt; Name of Installer &gt;</p>
                                    <p>&lt; Address Line 1 &gt;</p>
                            ...
                            <tr>
                                <td class="border-top-yellow" valign="top"><b>Installer 3</b></td>
                                <td valign="top">:</td>
                                <td class="border-top-yellow">
                                    <p>&lt; Name of Installer &gt;</p>
                                    <p>&lt; Address Line 1 &gt;</p>
                            ...
                            <tr>
                                <td class="border-top-yellow" valign="top"><b>Installer n</b></td>
                                <td valign="top">:</td>
                                <td class="border-top-yellow">
                                    <p>&lt; Name of Installer &gt;</p>
                                    <p>&lt; Address Line 1 &gt;</p>
