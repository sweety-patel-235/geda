    ...
    <div class="box">
        <div class="content">
            <div class="portlet box blue-madison applyonline-viewmain fesibility-report">
                ...
                <?php 
                    echo $this->Form->create($ReChargingCertificate, ['id'=>'ReChargingCertificate','name'=>'ReChargingCertificate','method'=>'post','type' => 'post','url' => 'Applications/ReChargingCertificate/'.$id]);
                        ...
                        <div class="fesibility-report form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php echo $ReChargingCertificate->created;?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <?php echo $Applications->name_of_consumer_applicant;?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><?php echo $Applications->consumer_no;?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <?php echo $Applications->sanction_load_contract_demand;?>kW
                                        </div>
                                    </div>
                                    <div class="row hide">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <?php echo $Applications->pv_capacity;?>kWp
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <?php echo $Applications->geda_application_no;?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <?php echo $this->Form->input('meter_installed_date',["type" => "text",'label'=>false,'id'=>'meter_installed_date',"class" => "form-control datepicker",'value'=>(isset($ReChargingCertificate->meter_installed_date)?date('d-m-Y',strtotime($ReChargingCertificate->meter_installed_date)):'')]);?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <?php echo $this->Form->input('agreement_date',["type" => "text",'label'=>false,'id'=>'agreement_date',"class" => "form-control datepicker",'value'=>(isset($ReChargingCertificate->agreement_date)?date('d-m-Y',strtotime($ReChargingCertificate->agreement_date)):'')]);?>
                                        </div>
                                    </div>
                                </div>
                            </div>
