...
<div class="container-fluid applications-from">
	<div class="row col-md-12">
		<h4 class="<?php echo $titleClass;?> mb-sm mt-sm"><strong>Application</strong> Meter Approval</h4>
			...
			<div class="table table-responsive table-bordered noborder" >
				 ...
				 <table id= "tbl_wind_info" class="table table-striped table-bordered table-hover custom-greenhead" >
				  	...
				  	<tr class="thead-dark">
				  		...
				  		<th colspan="4" style="text-align:center;" >Meter Approval</th>
				  		</thead>
				  	</tr>
				  	<tr >
				  		<td  style="text-align:center;" >Sr No </td>
				  		<td  style="text-align:center;" >WTG Location </td>
				  		<td  style="text-align:center;" >Meter Approval</td>
				  	...
				  	<tbody>
				  		<?php $counter =1;
				  		 foreach ($wtg_applications as $key => $value) {
				  		 	$meter_status 		= $MeterSealingApplicationDetails->check_meter_approval_status($value['id']);
				  			...
				  			<tr >
						  		...
						  		<td style="text-align:center;" ><a href="javascript:;" data-toggle="modal" data-target="#METER_SEALINGApproval" class="METER_SEALINGApproval dropdown-item" data-id="<?php echo encode($value->application_id); ?>" data-geoid ="<?php echo $value->id; ?>"><i class="fa fa-check-square-o"></i> Meter Approval
													</a></td>
						  		<td style="text-align:center;" > <?php echo !empty($meter_status->meter_approve)?' Completed' :'-' ?></td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group text">
						...
						<?php echo $this->Form->input('METER_SEALINGApproval_app_geo_loc_id', ['id' => 'METER_SEALINGApproval_app_geo_loc_id', 'label' => true, 'type' => 'hidden']); ?>
...
$(".METER_SEALINGApproval").click(function() {
	...
	$("#METER_SEALINGApproval_app_geo_loc_id").val(app_geo_loc_id);
...
$(".METER_SEALINGApproval_btn").click(function() {
	...
	$.ajax({
		type: "POST",
		url: "/Applications/METER_SEALINGApprovalDocumentAll",
