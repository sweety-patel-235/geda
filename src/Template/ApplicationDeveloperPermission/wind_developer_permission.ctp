	...
	<div class="tabs tabs-bottom tabs-simple nk_tabs">
		...
		<div class="subsidy-claim tab-content">
			...
			<div class="tab-pane <?php echo ($tab_id == 2) ? 'active' : ''; ?>" id="technical">
				...
				<?php echo $this->element('application-developer-permission/wind_technical_details'); ?>

			</div>
			<div class="tab-pane <?php echo ($tab_id == 3) ? 'active' : ''; ?>" id="project">

				<?php echo $this->element('application-developer-permission/wind_project_details'); ?>

			</div>
			<div class="tab-pane <?php echo ($tab_id == 4) ? 'active' : ''; ?>" id="upload">

				<?php echo $this->element('application-developer-permission/wind_upload_details'); ?>
...
<script type="text/javascript">
	$(document).ready(function() {
		LandDoc();
		const initializeFileInput = (selector, errorContainer) => {
			$(selector).fileinput({
				showUpload: false,
				showPreview: false,
		...
		initializeFileInput("#undertaking_dec", '#undertaking_dec-file-errors');
		initializeFileInput("#micro_sitting_drawing", '#micro_sitting_drawing-file-errors');
		initializeFileInput("#proof_of_ownership", '#proof_of_ownership-file-errors');
		initializeFileInput("#notarized_contract", '#notarized_contract-file-errors');
		initializeFileInput("#ca_certificate", '#ca_certificate-file-errors');
		initializeFileInput("#invoice_with_gst", '#invoice_with_gst-file-errors');
		initializeFileInput("#share_subscription", '#share_subscription-file-errors');
		initializeFileInput("#pvt_proposed_land", '#pvt_proposed_land-file-errors');
		initializeFileInput("#proj_sale_to_discom_no_due", '#proj_sale_to_discom_no_due-file-errors');
		initializeFileInput("#proj_captive_use_no_due", '#proj_captive_use_no_due-file-errors');
		initializeFileInput("#deed_doc_0", '#deed_doc_0-file-errors');
		initializeFileInput("#upload_sale_to_discom", '#upload_sale_to_discom-file-errors');
		initializeFileInput("#no_due_1", '#no_due_1-file-errors');
		initializeFileInput("#no_due_2", '#no_due_2-file-errors');
		initializeFileInput("#upload_proof_of_ownership_1", '#upload_proof_of_ownership_1-file-errors');
		initializeFileInput("#upload_proof_of_ownership_2", '#upload_proof_of_ownership_2-file-errors');
		initializeFileInput("#doc_of_beneficiary", '#doc_of_beneficiary-file-errors');
		initializeFileInput("#copy_of_conventional_electricity", '#copy_of_conventional_electricity-file-errors');
		initializeFileInput("#stamp_of_re_gen_plant", '#stamp_of_re_gen_plant-file-errors');
		initializeFileInput("#rec_accrediation_cer", '#rec_accrediation_cer-file-errors');
		initializeFileInput("#electricit_bill_of_third_party", '#electricit_bill_of_third_party-file-errors');
		initializeFileInput("#multi_third_party", '#multi_third_party-file-errors');
		initializeFileInput("#copy_of_electricity_bill", '#copy_of_electricity_bill-file-errors');
		initializeFileInput("#permission_letter_of_getco", '#permission_letter_of_getco-file-errors');
		initializeFileInput("#captive_share_register", '#captive_share_register-file-errors');
		//1 share
		initializeFileInput("#captive_ca_cs_certi", '#captive_ca_cs_certi-file-errors');
		initializeFileInput("#captive_balance_sheet", '#captive_balance_sheet-file-errors');
		initializeFileInput("#captive_annual_audit", '#captive_annual_audit-file-errors');
		// 2 share
		initializeFileInput("#partnership_deed", '#partnership_deed-file-errors');
		initializeFileInput("#partnership_share_holding", '#partnership_share_holding-file-errors');
		initializeFileInput("#partnership_return_filed", '#partnership_return_filed-file-errors');
		// 3 share
		initializeFileInput("#limited_share_register", '#limited_share_register-file-errors');
		initializeFileInput("#limited_share_certi", '#limited_share_certi-file-errors');
		initializeFileInput("#limited_company_secretary_certi", '#limited_company_secretary_certi-file-errors');
		//4 share
		initializeFileInput("#association_certified_return_filed", '#association_certified_return_filed-file-errors');
		initializeFileInput("#association_share_register", '#association_share_register-file-errors');
		initializeFileInput("#association_certi_of_ca", '#association_certi_of_ca-file-errors');
		initializeFileInput("#certi_from_company_secretary", '#certi_from_company_secretary-file-errors');
		//5 share
		initializeFileInput("#cooperative_certi_from_district_registrar", '#cooperative_certi_from_district_registrar-file-errors');
		initializeFileInput("#cooperative_share_register", '#cooperative_share_register-file-errors');
		// 6 share
		initializeFileInput("#spv_company_return_file", '#spv_company_return_file-file-errors');
		initializeFileInput("#spv_company_certi_of_share_register", '#spv_company_certi_of_share_register-file-errors');
		initializeFileInput("#spv_company_memorandum", '#spv_company_memorandum-file-errors');
		initializeFileInput("#spv_company_articles_of_associate", '#spv_company_articles_of_associate-file-errors');
		initializeFileInput("#spv_company_company_secretary", '#spv_company_company_secretary-file-errors');
		//7 share
		initializeFileInput("#cgp_holding_annual_balance_sheet", '#cgp_holding_annual_balance_sheet-file-errors');
		initializeFileInput("#cgp_holding_acc_of_company", '#cgp_holding_acc_of_company-file-errors');
		//8 share
		initializeFileInput("#cgp_annual_balance_sheet", '#cgp_annual_balance_sheet-file-errors');
		initializeFileInput("#cgp_acc_of_company", '#cgp_acc_of_company-file-errors');
		...
		$('#end_stu').on('change', function() {
			...
			if (this.value == '1') {
				...
				$(".equity-share-cgp").hide();
				$('.share-doc-1, .share-doc-2, .share-doc-3, .share-doc-4, .share-doc-5, .share-doc-6, .share-doc-7, .share-doc-8').find('.fileinput-remove-button').click();
				$('.share-doc-1, .share-doc-2, .share-doc-3, .share-doc-4, .share-doc-5, .share-doc-6, .share-doc-7, .share-doc-8').hide();
				$(".equity-share-cgp").find("option:selected").removeAttr("selected");
		...
		$('#equity_share').on('change', function(){
			...
			$(".equity-share-cgp").find("option:selected").removeAttr("selected");
			if (this.value == '2') {
				$(".equity-share-cgp").show();
			} else if (this.value == '1') {
				$(".equity-share-cgp").hide();
				
			}
		});
		$('#equity_share').trigger('change');

		$('#cgp').on('change', function() {
    		const shareDocs = [1, 2, 3, 4, 5, 6, 7, 8];
    		const selectedDoc = this.value;
   
			shareDocs.forEach(doc => {
				const shareDocElement = $(`.share-doc-${doc}`);
				if (doc == selectedDoc) {
					shareDocElement.show();
				} else {
					shareDocElement.hide().find('.fileinput-remove-button').click();
				}
			});
		});
		$('#cgp').trigger('change');		
	...
	function change_injection() {
		...
		$(".equity-share").addClass('hide');
		$(".captive-only").addClass('hide');

		$(".captive-with-rpo").addClass('hide');
		$(".project-for-third-party").addClass('hide');
		$(".project-with-RE-mechanism").addClass('hide');		
		...
		if (injectionLevel == 1) {
			...
			$(".equity-share").removeClass('hide');
			$(".captive-only").removeClass('hide');
			$(".captive-with-rpo").removeClass('hide');
			$(".project-for-third-party").removeClass('hide');
			$(".project-with-RE-mechanism").removeClass('hide');
			$(".cls-ctu").find("option:selected").removeAttr("selected");
		} else {
	...
	function toggel_third_party_detail() {
		...
		$("input[type=radio][name=details_of_third_party]").each(function(opt) {
			if ($(this).is(":checked") && $(this).val() == 1) {
				...
				$('.third-party-details input[type="text"]').val('');
				$('.third-party-details textarea').val('');
				$('.third-party-details input[type="radio"]').prop('checked', false);
	...
	function capacity_of_stoa() {
		...
		$("input[type=radio][name=certi_of_stoa]").each(function(opt) {
			if ($(this).is(":checked") && $(this).val() == 1) {
				...
				$('.capacity-of-stoa input[type="text"]').val('');
			}
			if ($(this).is(":checked") && $(this).val() == 0) {
				$(".capacity-of-stoa").addClass('hide');
			}
	...
	function stamp_re_gen_plant() {
		...
		$("input[type=radio][name=RE_generating_plant]").each(function(opt) {
			if ($(this).is(":checked") && $(this).val() == 1) {
				...
				$('.stamp-of-re-gen-plant-div').find('.fileinput-remove-button').click();
			}
			if ($(this).is(":checked") && $(this).val() == 0) {
				$(".stamp-of-re-gen-plant-div").addClass('hide');
			}
	...
	function captive_power_plant() {
		...
		$("input[type=radio][name=captive_conv_power_plant]").each(function(opt) {
			if ($(this).is(":checked") && $(this).val() == 1) {
				...
				$('.captive-power-plant').find('.fileinput-remove-button').click();
				$('.captive-power-plant input[type="text"]').val('');
			}
			if ($(this).is(":checked") && $(this).val() == 0) {
				$(".captive-power-plant").addClass('hide');
			}
	...
	function phy_copy_of_rec_reg_web_toggle() {
		...
		$("input[type=radio][name=phy_copy_of_rec_reg_web]").each(function(opt) {
			if ($(this).is(":checked") && $(this).val() == 1) {
				...
				$(".rec-mechanism").addClass('hide');
				$('.project-with-RE-mechanism').find('.fileinput-remove-button').click();
				$('input[name="receipt_copy_of_rec_reg_web"]').prop('checked', false);
				$('input[name="power_eva_arra_per"]').prop('checked', false);
			}
			if ($(this).is(":checked") && $(this).val() == 0) {
				$(".rec-mechanism-upload").addClass('hide');
	...
	// 							window.location.href = '/wind-permission/' + encode_application_id + '/3';
	// 						}
	// 					}
	// 				});
