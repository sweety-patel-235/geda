	...
	<div class="container">
		...
		<div class="row" style="border:2px solid lightgreen; border-radius:5px; padding-top:10px;">
			<div class="col-md-12">
				...
				<fieldset>
					<legend><?php echo ($registration_type!=1) ? 'Installer' : '';?> Information</legend>
					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col-md-4">
								<label>Fax </label>
								<?php
								echo $this->Form->input('Installers.fax_no',array('label' => false,'class'=>'form-control')); ?>
							</div>
							<div class="col-md-4">
								<label>Website </label>
								<?php
					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col-md-4">
								<label class="lbl_comunication_address">
								Total Processing Fees including GST (in &#8377;) <?php echo number_format((INSTALLER_PAYMENT_FEES + INSTALLER_GST_AMOUNT),2);?></label>
								<?php /*
