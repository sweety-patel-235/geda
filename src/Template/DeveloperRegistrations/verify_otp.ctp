...
$(".resendotp_btn").click(function() {
	window.location.href='/developer-resend-otp/0/'+$("#insid").val();
});
$(".resendemailotp_btn").click(function() {
	window.location.href='/developer-resend-otp/1/'+$("#insid").val();
});
function click_registration()
{

	window.location.href="<?php echo URL_HTTP.'developer-registration/'.$company_id;?>"
}
</script>
