				...
				<div class="col-md-12 portlet-body form">
					<div class="form-body">
						<div class="row">
							...
							<div class="form-group">
								<div class="col-md-12">
									<label>Name of the Solar Installer Company </label>
									...
									<table class="table-responsive table-bordered"> 
		                                <tbody>
		                                    <tr>
		                                        ...
		                                        <td><?php echo number_format(INSTALLER_PAYMENT_FEES,2); ?></td>
		                                    </tr>
		                                    <tr>
		                                        <td>GST at 18%</td>
		                                        <td><?php echo number_format(INSTALLER_GST_AMOUNT,2); ?></td>
		                                    </tr>
		                                    <tr>
		                                        <td><b>Total Fee</b></td>
		                                        <td><b><?php echo number_format((INSTALLER_PAYMENT_FEES + INSTALLER_GST_AMOUNT),2);?></b></td>
		                                    </tr>
		                                </tbody>
	                            	</table>
	                            	<br>
	                            	<?php if($installerData->payment_status != 1) { ?>
		                            	<a href="/payutransfer/installer-payment/<?php echo encode($installerData->id);?>">
