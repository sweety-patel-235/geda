                ...
                <div class="row col-md-12">
                    ...
                    if($is_member)
                    {
                        ...
                        <div class="col-md-3 " style="padding-left: 0px;">
                            ...
                            <?php //echo $this->Form->select('installer_name',$Installers,array('label' => false,'div'=>false,'class'=>'form-control chosen-select','id'=>'installer_name','style'=>'margin-left:-15px;','multiple'=>'true','data-placeholder'=>'-Select Installers-')); 
                                echo $this->Form->select('installer_name_multi',$Installers,array('label' => false,'class'=>'form-control chosen-select','empty'=>'-Select Installers-','id'=>'installer_name','data-placeholder'=>'-Select Installers-',"multiple"=>"multiple")); ?>
                        </div>
                        <?php
                    }
                    ?>
            ...
            <div class="portlet box blue-madison noborder">
                <table class="table table-striped table-bordered table-hover custom-greenhead frontlayout-activesort" id="table-example">
                    ...
                    <tr>
                        ...
                        <th class="">Status</th>
                        <th class="">Verified At DisCom</th>
                        <?php
                        if($is_member)
                        {
                            if($memberApproved == 1)
...
$(document).on("click", ".approve_Status" , function() {
    ...
    ({
        type: "POST",
        url: "/ApplyOnlines/fetchUpdateRequest",
...
$(".request_approval_btn").click(function(event) {
    ...
    console.log(fromobj);
        $.ajax({
                type: "POST",
                url: "/ApplyOnlines/ApproveRequest",
