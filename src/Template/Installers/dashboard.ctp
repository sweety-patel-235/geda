    ...
    <div class="row_back">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                <?php
                    echo $this->Form->create("form-main",array('type'=>'post','id'=>'form-main', 'url' => '/apply-online-list'));?>
                        ...
                        <fieldset>
                            ...
                            <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
                                <a class="dashboard-stat dashboard-stat-v2 green residential_box" href="javascript:;" data-id="<?php echo $arrStatusCode['RESIDENTIAL'];?>">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span data-counter="counterup" data-value="<?php echo $TotalResidentialPVCapacity; ?>">
...
<?php /*script src="//maps.googleapis.com/maps/api/js?key=<?php echo GOOGLE_MAP_API_KEY;?>" type="text/javascript"></script>
<script type="text/javascript" src="/js/gmap/gmap3.js"></script>*/?>
<script type="text/javascript">
    var CustomerList = <?php echo isset($getProjectClusterData['data']) ?  json_encode($getProjectClusterData['data']) : '[]';?>;
