 ...
 */
class HybridEvaculationPoolingDataTable extends AppTable
{
	/**
	 *
	 ...
	 *
	 */
	var $table = 'hybrid_evaculation_pooling_data';
	...
	public function save_pooling($application_id,$arr_data,$member_id)
	{
		...
		$save_data           							= TableRegistry::get('HybridEvaculationPoolingData');		
