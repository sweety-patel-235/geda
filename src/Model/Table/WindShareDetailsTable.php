 ...
 */
class WindShareDetailsTable extends AppTable
{
	/**
	 *
	...
	public function save_wind_share_details($application_id,$arr_land_detail,$member_id)
	{
		
		$save_data           							= TableRegistry::get('WindShareDetails'); 
	...
	{
		$fetch_wind_details = $this->find('all',array('conditions'=>array('app_dev_per_id'=>$application_id)))->toArray();		
		return $fetch_wind_details;
	}
