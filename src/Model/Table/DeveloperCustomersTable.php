...
class DeveloperCustomersTable extends AppTable
{
	var $STATUS_ACTIVE 			= 1;
	...
	var $validationSet				= "";
	var $validate					= array();
	var $table 						= 'developer_customers';

	public function initialize(array $config)
    {
        $this->table('developer_customers');
        $this->addAssociations([
          //'hasMany' => ['EventInvitations','EventBids','EventLogs','EventLots'],
          'belongsTo' => ['Developers']
        ]);
    }
    ...
    */
	...
	public function ChangeDeveloperPassword($customer,$NewPassword) 
	{
		...
		if(!empty($customer->email)) {
			...
			$customer_entity->user_type 		= 'developer';
