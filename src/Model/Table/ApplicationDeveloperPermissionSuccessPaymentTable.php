...
*/
class ApplicationDeveloperPermissionSuccessPaymentTable extends Table {
/**
 * The status of $name is universe
 * Potential value are Class Name
 * @var String
 */
	public $Name 	= 'ApplicationDeveloperPermissionSuccessPayment';
	 ...
	 * @var String
	 */
	public $useTable = 'developer_permission_success_payment';
