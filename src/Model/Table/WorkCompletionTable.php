...
class WorkCompletionTable extends AppTable
{
	var $table                 = 'workcompletion';
    var $ModuleTypes           = array(1=>"Thin Film",2=>"Monocrystalline",
                                       3=>"PolyCrystalline",4=>"Any Other");
	var $InverterTypes         = array(1=>"Hybrid",2=>"PCU Inverter",
                                       3=>"Micro Inverter",4=>"String Inverter",
                                       4=>"Central Inverter",6=>"Any Other");
    ...
    {
        $workcompletion   = $this->find('all',['conditions'=>['application_id'=>$id]])->first();
