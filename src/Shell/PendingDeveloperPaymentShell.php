...
class PendingDeveloperPaymentShell extends Shell
{
	...
	public function main()
	{
		...
		$pendingInstallers 	= $this->DeveloperPaymentRequest->find('all',array(
													...
													'conditions'=> array('request_data IS NOT NULL','developers.payment_status !='=>'1')))->distinct(['DeveloperPaymentRequest.installer_id'])->toArray();
