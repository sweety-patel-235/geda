<?php
$DEBUG = (isset($_SERVER['REMOTE_ADDR']) && ($_SERVER['REMOTE_ADDR'] == "203.88.138.46")?true:true);
$DEBUG = (isset($_SERVER['REMOTE_ADDR']) && ($_SERVER['REMOTE_ADDR'] == "203.88.147.186")?true:true);
...
return [
   ...
   /* 'EmailTransport' => [
        'default' => [
            'className' => 'Smtp',
            // The following keys are used in SMTP transports
            'host' => 'mail.ahasolar.in',
            'port' => 25,
            'timeout' => 30,
            'username' => 'do-not-reply@ahasolar.in',
            'password' => 'Jfmd83#6',
            'client' => null,
            'tls' => null,
        ],
...
'EmailTransport' => [
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => 'jayshree.tailor@gmail.com',
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'username' => 'rr_web',
            'password' => 'PUVqF8fr',
            'database' => 'ahasolar_geda_latest',
            // 'username' => 'root',
            // 'password' => '',
            // 'database' => 'ahasolar_gujarat',
            //'database' => 'geda_live',
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
